...
let arrayProjectName = ["Android", "Horas", "Previsão do Tempo", "Lista de Tarefas", "Pokedex", "Jogo da Memória", "Jogo da Velha", "Paint", "Advinha", "ImovelGuide", "Movies", "Spectrus", "Chat", "Rede Social", "Drone Tello"];
